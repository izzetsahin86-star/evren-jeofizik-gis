const CACHE_VERSION = 'evren-gis-v45'
const SHELL_CACHE = `${CACHE_VERSION}-shell`
const TILE_CACHE = `${CACHE_VERSION}-tiles`
const SHELL_FILES = ['/', '/index.html', '/offline.html', '/manifest.webmanifest', '/icons/evren-jeofizik-touch-v3.png', '/icons/evren-jeofizik-192-v3.png', '/icons/evren-jeofizik-512-v3.png', '/icons/evren-jeofizik-maskable-512-v3.png', '/icons/evren-jeofizik-logo.svg', '/icons/evren-logo.png', '/fonts/EvrenSans.ttf', '/fonts/EvrenSans-Bold.ttf']
